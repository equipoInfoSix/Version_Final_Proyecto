...
if(!$connection) 
        ...
        $instruccion_SQL = "UPDATE sucursal SET snd='$snd', nte='$nte', inftca='$inftca', atm='$atm', telmex='$telmex', cfe='$cfe', llaves='$llaves', vigilancia='$vigilancia', agua='$agua', luz='$luz', drenaje='$drenaje', plantaEmergencia='$plantaEmergencia', ups='$ups', cajaChica='$cajaChica', cajaGrande='$cajaGrande' WHERE noSucursal='$noSucursal'";
